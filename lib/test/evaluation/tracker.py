...
class Tracker:
    ...
    def __init__(self, name: str, parameter_name: str, dataset_name: str, run_id: int = None, display_name: str = None,
                 result_only=False, debug=False, pth=None):
        ...
        if pth is not None:
            ...
            self.params.checkpoint = os.path.join(save_dir, "checkpoints/train/ESTrack/%s/ESTrack_ep%04d.pth.tar" %
                                     (yaml_name, pth))
        # self.create_tracker(params)
        print("now load pth is : ", self.params.checkpoint)
        ## 新增
