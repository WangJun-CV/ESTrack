...
if __name__ == "__main__":
    ...
    parser.add_argument('--cfg_name', default='cae_center_all_ep300_300', type=str, help='Name of config file.')
    ...
    # dest_dir = os.path.join(result_dir, "%s/got10k_submit/%s/" % (tracker_name, cfg_name))
    
    listglob = glob.glob(src_dir)
    listglob.sort()
    src_list = listglob
    dst_list = [ os.path.join(result_dir, "%s/%s/got10k_submit/"
