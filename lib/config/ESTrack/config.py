...
cfg.MODEL.USE_CLS_TOKEN = True
cfg.MODEL.USE_QUALITY_SCORE = False
cfg.MODEL.ADD_TEMPLATE_TARGET_EMBED = False

# MODEL.BACKBONE
cfg.MODEL.BACKBONE = edict()
cfg.MODEL.BACKBONE.TYPE = "cae_vit_base_patch16_224"
cfg.MODEL.BACKBONE.STRIDE = 16
cfg.MODEL.BACKBONE.ADD_CLS_TOKEN = False
cfg.MODEL.BACKBONE.CLS_TOKEN_USE_MODE = 'ignore'
cfg.MODEL.BACKBONE.AI_LAYERS = 3
cfg.MODEL.BACKBONE.DEPTH = 9

cfg.MODEL.BACKBONE.CE = False
