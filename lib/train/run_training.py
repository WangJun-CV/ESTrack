...
def run_training(script_name, config_name, cudnn_benchmark=True, local_rank=-1, save_dir=None, base_seed=None,
    ...
    expr_func(settings)#3
#
def main():
    parser = argparse.ArgumentParser(description='Run a train scripts in train_settings.')
    parser.add_argument('--script', default='ESTrack', type=str, required=False, help='Name of the train script.')
    parser.add_argument('--config', default='cae_center_all_ep300', type=str, required=False,
