...
from lib.models import build_ostrack, build_ESTrack
...
def run(settings):
    ...
    elif settings.script_name == "ESTrack":
        net = build_ESTrack(cfg)
    else:
    ...
    qfl = QFL()
    # negL = negL()
    if settings.script_name == "ostrack" or settings.script_name == "ESTrack":
