...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='ESTrack', choices=['ESTrack'],
                        help='training script name')
    parser.add_argument('--config', type=str, default='cae_center_all_ep300', help='yaml configure file name')
...
if __name__ == "__main__":
    ...
    if args.script == "ESTrack":
        model_module = importlib.import_module('lib.models')
        model_constructor = model_module.build_ESTrack
        model = model_constructor(cfg, training=False)
